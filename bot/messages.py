...
обратитесь в нашу тех.поддержку:\n\
@avistat_support'

REPORT_FAILED = 'Не удалось обработать вашу ссылку. Обратитесь в поддержку'
